...
class SimpleWarp : JavaPlugin() {
    ...
    private fun registerCommands() {
        ...
        setWarpCommand.setExecutor(SetWarpCommand())
        warpsCommand.setExecutor(WarpsCommand())
        delWarpCommand.setExecutor(DelWarpCommand())
        warpCommand.setExecutor(WarpCommand())
        warpCommand.tabCompleter = WarpCommand()
        warpVersionCommand.setExecutor(WarpVersionCommand())
        positionCommand.setExecutor(PositionCommand())
        positionCommand.tabCompleter = PositionCommand()
    }
